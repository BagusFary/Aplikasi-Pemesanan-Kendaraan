                                ...
                                <div class="d-flex justify-content-center">
                                    ...
                                    <div class="modal fade" id="editModal-{{ $item->id }}" data-bs-backdrop="static"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Edit Kendaraan
                                                    </h1>
                                                        ...
                                                        <form action="/update-kendaraan" method="POST">
                                                            ...
                                                            <div class="mb-2">
                                                                ...
                                                                <input type="text" class="form-control" name="nama"
                                                                    id="nama" placeholder="L300"
                                                                    value="{{ $item->nama }}" required>
                                                            </div>
                                                            <div class="mb-2">
                                                                <label for="plat" class="form-label">Plat</label>
                                                                <input type="text" class="form-control" name="plat"
                                                                    id="plat" placeholder="GH 5500"
                                                                    value="{{ $item->plat }}" required>
                                                            </div>
                                                            <div class="mb-2">
                                                                <label for="konsumsi_bbm_per_km"
                                                                    class="form-label">Konsumsi BBM /KM</label>
                                                                <input type="number" class="form-control"
                                                                    name="konsumsi_bbm_per_km" id="konsumsi_bbm_per_km"
                                                                    placeholder="15000"
                                                                    value="{{ $item->konsumsi_bbm_per_km }}" required>
                                                            </div>
                                                            <div class="mb-2">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" class="btn btn-primary" onclick="console.log('test')">Simpan</button>
                                                </div>
                                                </form>
                                            </div>
                                        </div>
